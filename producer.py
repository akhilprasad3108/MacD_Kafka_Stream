...
kafka_config = {
    ...
    'sasl.username': 'TSZSVNZZUPI3XM7H',
    'sasl.password': '/qpapbdRSmRAdYMkL04+p2K3Kc9knBEBRW9mK/zCRXblBsNbntxVnx0c7K+6iyYP'
}

schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-10dzz.ap-southeast-2.aws.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('U5ZHUKE25VQHSIUB', 'ki6VM9rVKTjF+pEqg5UgFOPUDhQRvEVZw4SK8LpVGa2VXMjZcG5Jqt3geIPYPxmB')
})
